...
make_group(gp2,
  ...
  /* 0xf6, 0xf7 */
make_group(gp3,
    IDEX(test_I,test), EX(test), EX(not), EX(neg),
...
make_group(gp5,
    ...
    EX(jmp_rm), EX(jmp), EX(push_rm), EMPTY)
...
opcode_entry opcode_table [512] = {
  ...
  /* 0x0c */	IDEXW(I2a, or, 1), IDEXW(I2a, or, 4), EMPTY, EX(2byte_esc),
  ...
  /* 0x68 */	IDEX(I, push), IDEXW(I_E2G, imul3, 4),IDEXW(I, push, 1), IDEXW(SI_E2G, imul3, 1), 
  ...
  /* 0x8c */	EMPTY, IDEX(lea_M2G, lea), EMPTY, IDEXW(E, pop, 4), 
  /* 0x90 */	EX(nop), EMPTY, EMPTY, EMPTY,
  /* 0x94 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x98 */	IDEX(none, cwtl), IDEX(none, cltd), EMPTY, EMPTY,
  ...
  /* 0xe4 */  IDEXW(in_I2a, in, 1), IDEX(in_I2a, in), IDEXW(out_a2I, out, 1), IDEX(out_a2I, out),
	/* 0xe8 */	EX( call),IDEX(J, jmp), EMPTY, IDEXW(J, jmp, 1),
